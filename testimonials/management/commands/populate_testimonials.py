...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        # Get some services to link testimonials to
        ...
        # Sample testimonials data - linking to specific services
        testimonials_data = [
            {
                'customer_name': 'Samantha Lee',
                'company': 'Orion Tech',
                'job_title': 'Operations Manager',
                'service_slug': 'ai-powered-virtual-assistant',  # DocuMind equivalent
                'rating': 5,
            ...
            },
            {
                ...
                'job_title': 'CFO',
                'service_slug': 'predictive-analytics-platform',  # FinSight equivalent
                'rating': 5,
            ...
            },
            {
                ...
                'service_slug': 'intelligent-process-automation',  # Log AI equivalent
                'rating': 4,
            ...
            },
            {
                ...
                'service_slug': 'computer-vision-solutions',  # LaundriQ equivalent
                'rating': 5,
            ...
            },
            {
                ...
                'service_slug': 'digital-employee-experience-analytics',  # SafeOps equivalent
                'rating': 5,
